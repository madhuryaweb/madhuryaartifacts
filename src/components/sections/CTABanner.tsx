      ...
      <div className="container-md">
        ...
        >
          ...
          <div className="relative z-10 text-center max-w-2xl  mx-auto">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl text-white md:text-5xl leading-tight mb-5">
              Elevate Your Space
              <br />
            ...
            <p className="text-white/70 text-sm sm:text-base mb-10">
              Transform your interiors with expert styling that brings warmth,
              elegance, and character to every corner.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                rounded-full hover:opacity-90 transition hover:bg-white hover:text-charcoal "
              >
                Contact Us
              </a>
